...
// Set location
float lat=51.00199640;
float lon=13.84047860;
int   alt=115;

/* Informal status fields */
static char platform[24]    = "Single-Channel Gateway";                 /* platform definition */
static char email[40]       = "benjamin.hempel@htw-dresden.de";         /* used for contact email */
static char description[64] = "Raspberry Pi 4 w/ Dragino LoRa/GPS HAT"; /* used for free form description */
